...
import com.uteacher.attendancetracker.ui.components.AttenoteTimePickerDialog
import com.uteacher.attendancetracker.ui.screen.createclass.components.ScheduleSlotCard
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                Box {
                    OutlinedButton(
                        ...
                        Text(
                            text = if (uiState.semester.isBlank()) "Select Semester *" else uiState.semester
                        )
                    }
                    DropdownMenu(
                ...
                if (!uiState.semesterError.isNullOrBlank()) {
                    Text(
                        text = uiState.semesterError!!,
                        style = MaterialTheme.typography.bodySmall,
        ...
        AttenoteSectionCard(title = "Date Range") {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedButton(
                    ...
                    Text(text = uiState.startDate?.toString() ?: "Select Start Date *")
                }
                ...
                OutlinedButton(
                    ...
                    Text(text = uiState.endDate?.toString() ?: "Select End Date *")
                }
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                Box {
                    OutlinedButton(
                        ...
                        Text(
                            text = uiState.currentSlot.dayOfWeek.getDisplayName(
                                TextStyle.FULL,
                                Locale.getDefault()
                            )
                        )
                ...
                Row(
                    ...
                    OutlinedButton(
                        ...
                        Text(text = uiState.currentSlot.startTime.format(TimeFormatter))
                    }
                    ...
                    OutlinedButton(
                        ...
                        Text(text = uiState.currentSlot.endTime.format(TimeFormatter))
                    }
                }
